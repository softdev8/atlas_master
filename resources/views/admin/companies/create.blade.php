...
@section('flex-content')
    ...
    <div id="flex-container">
        <div class="flex-element-cart">
            <form method="POST" class="flex-element-item" action="{{ route('admin.companies.store') }}">
                @csrf
                <div class="margin-bottom-20 text-center">
                    {!! Form::label(null, 'Company create') !!}
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input id="website" type="text" class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}" name="website" value=""  autofocus>
                    </div>
                </div>
